...
import { Users, Globe, Flame, Activity, Send, ArrowRight } from 'lucide-react';
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      >
        ...
        <div className="mt-2 text-xs text-slate-400 flex items-center justify-between">
          ...
          <span className="text-[11px] text-slate-400 group-hover:text-slate-200 flex items-center gap-0.5">
            View all →
          </span>
        </div>
      </button>
      ...
      {/* No Website (High Intent Redesign) */}
      <button
      ...
      >
        ...
        <div className="mt-2 text-xs text-slate-400 flex items-center justify-between">
          <span>Click to view emailed leads</span>
          <span className="text-[11px] text-slate-400 group-hover:text-slate-200 flex items-center gap-0.5">
            Review →
          </span>
        </div>
